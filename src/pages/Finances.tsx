            ...
            {ganancia > 0 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white rounded-2xl p-4 space-y-3" style={{ boxShadow: CARD_SHADOW }}>
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between"><div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full" style={{ background: '#2D1B69' }} /><span className="text-xs" style={{ color: '#8a8a9a' }}>Necesidades</span></div><span className="text-sm font-semibold font-nunito" style={{ color: '#2D1B69' }}>{formatCurrency(necesidades)}</span></div>
                  <div className="flex items-center justify-between"><div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full" style={{ background: '#C06DD6' }} /><span className="text-xs" style={{ color: '#8a8a9a' }}>Deseos</span></div><span className="text-sm font-semibold font-nunito" style={{ color: '#2D1B69' }}>{formatCurrency(deseos)}</span></div>
                  <div className="flex items-center justify-between"><div className="flex items-center gap-2"><Star className="w-3 h-3" style={{ color: '#C06DD6' }} /><span className="text-xs" style={{ color: '#8a8a9a' }}>Ahorro / Sueños</span></div><span className="text-sm font-bold font-nunito" style={{ color: '#6B2FA0' }}>{formatCurrency(ahorro)}</span></div>
                </div>
